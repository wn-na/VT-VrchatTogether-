...
export default class AvatarDetail extends Component {  
    constructor(props) {
        console.info("AvatarDetail => constructor");
    ...
    UNSAFE_componentWillMount() {
        console.info("AvatarDetail => componentWillMount");
        this.getMapDetail();
        this.timeout();
    }

    componentWillUnmount() {
        console.info("AvatarDetail => componentWillUnmount");
    }
    componentDidMount() {
        console.info("AvatarDetail => componentDidMount");
    }
    ...
    render() {
        console.info("AvatarDetail => render"); 
        Moment.locale('ko');
