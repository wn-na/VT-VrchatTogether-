...
export default class BlockDetail extends Component {
    constructor(props) {
        console.info("BlockDetail => constructor");
    ...
    async UNSAFE_componentWillMount() {
        console.info("BlockDetail => componentWillMount");
    ...
    componentWillUnmount() {
        console.info("BlockDetail => componentWillUnmount");
    }

    componentDidMount() {
        console.info("BlockDetail => componentDidMount");
    }
    ...
    favorite(number,id) {
        console.info("BlockDetail => favoriteWorld")
    ...
    render() {
        console.info("BlockDetail => render");
                ...
                {this.state.getUserInfo != null ? 
                    <ScrollView>
                        ...
                        <View style={{width:"100%",paddingLeft:"5%",paddingRight:"5%",marginBottom:"3.5%"}}>
                            <Button 
                            onPress={()=> Actions.currentScene == "blockDetail" ? Actions.makeDetail({userId:this.props.userId}) : {}}
